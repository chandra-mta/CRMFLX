...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "crmflx.numerical",
        "sources": [
            "src/crmflx/numerical.pyx"
        ]
    },
    "module_name": "crmflx.numerical"
}
END: Cython Metadata */
...
#define __PYX_HAVE__crmflx__numerical
#define __PYX_HAVE_API__crmflx__numerical
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
#define __Pyx_MODULE_NAME "crmflx.numerical"
extern int __pyx_module_is_main_crmflx__numerical;
int __pyx_module_is_main_crmflx__numerical = 0;

/* Implementation of "crmflx.numerical" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Numerical_operations_shared_by[] = "\nNumerical operations shared by multiple modules.\n";
/* #### Code section: decls ### */
...
#define __pyx_kp_b_pyx_ctuple_double__and_double __pyx_string_tab[9]
...
static CYTHON_INLINE double __pyx_f_6crmflx_9numerical_y_interpolate(double __pyx_v_x1, double __pyx_v_y1, double __pyx_v_x2, double __pyx_v_y2, double __pyx_v_xin) {
  double __pyx_v_yout;
  double __pyx_r;
  double __pyx_t_1;
  double __pyx_t_2;
 ...
 * 
*/
  __pyx_t_1 = ((__pyx_v_y1 - __pyx_v_y2) * (__pyx_v_x1 - __pyx_v_xin));
  __pyx_t_2 = (__pyx_v_x1 - __pyx_v_x2);
  if (unlikely(__pyx_t_2 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 19, __pyx_L1_error)
  }
  __pyx_v_yout = (__pyx_v_y1 - (__pyx_t_1 / __pyx_t_2));

  /* "crmflx/numerical.pyx":20
 *     """
 *     cdef double yout = y1 - (y1 - y2) *(x1 -xin) / (x1 - x2)
 *     return yout             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("crmflx.numerical.y_interpolate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}

/* "crmflx/numerical.pyx":22
 *     return yout
 * 
 * cdef double compute_rng(double xve, double yve, double zve, double xgsm, double ygsm, double zgsm):             # <<<<<<<<<<<<<<
 *     """
...
static double __pyx_f_6crmflx_9numerical_compute_rng(double __pyx_v_xve, double __pyx_v_yve, double __pyx_v_zve, double __pyx_v_xgsm, double __pyx_v_ygsm, double __pyx_v_zgsm) {
  double __pyx_v_rng;
  double __pyx_r;

  /* "crmflx/numerical.pyx":28
 *     cdef double rng
 * 
 ...
 *     return rng
*/
  __pyx_v_rng = sqrt(((pow((__pyx_v_xve - __pyx_v_xgsm), 2.0) + pow((__pyx_v_yve - __pyx_v_ygsm), 2.0)) + pow((__pyx_v_zve - __pyx_v_zgsm), 2.0)));

  /* "crmflx/numerical.pyx":30
 *     rng = sqrt((xve - xgsm)**2 + (yve - ygsm)**2 + (zve - zgsm)**2)
 * 
 *     return rng             # <<<<<<<<<<<<<<
 * 
...
static __pyx_ctuple_double__and_double __pyx_f_6crmflx_9numerical_rot8ang(double __pyx_v_ang, double __pyx_v_x, double __pyx_v_y, double __pyx_v_xhinge) {
  double __pyx_v_xrot2;
  double __pyx_v_yrot2;
  __pyx_ctuple_double__and_double __pyx_r;
  int __pyx_t_1;
  __pyx_ctuple_double__and_double __pyx_t_2;

  /* "crmflx/numerical.pyx":46
 *     cdef double yrot2
 * 
 *     if x <= xhinge:             # <<<<<<<<<<<<<<
...
*/
  __pyx_t_1 = (__pyx_v_x <= __pyx_v_xhinge);
  if (__pyx_t_1) {

    /* "crmflx/numerical.pyx":47
 * 
 *     if x <= xhinge:
 *         xrot2 =  x * cos(ang) + y * sin(ang)             # <<<<<<<<<<<<<<
 *         yrot2 = -x * sin(ang) + y * cos(ang)
 *     else:
*/
    __pyx_v_xrot2 = ((__pyx_v_x * cos(__pyx_v_ang)) + (__pyx_v_y * sin(__pyx_v_ang)));

    /* "crmflx/numerical.pyx":48
 *     if x <= xhinge:
 *         xrot2 =  x * cos(ang) + y * sin(ang)
 *         yrot2 = -x * sin(ang) + y * cos(ang)             # <<<<<<<<<<<<<<
 *     else:
 *         xrot2 = x
*/
    __pyx_v_yrot2 = (((-__pyx_v_x) * sin(__pyx_v_ang)) + (__pyx_v_y * cos(__pyx_v_ang)));
...
*/
  /*else*/ {
    __pyx_v_xrot2 = __pyx_v_x;

    /* "crmflx/numerical.pyx":51
 *     else:
 *         xrot2 = x
 *         yrot2 = y             # <<<<<<<<<<<<<<
 * 
 *     return xrot2, yrot2
*/
    __pyx_v_yrot2 = __pyx_v_y;
  }
  __pyx_L3:;

  /* "crmflx/numerical.pyx":53
 *         yrot2 = y
 * 
 *     return xrot2, yrot2             # <<<<<<<<<<<<<<
*/
  __pyx_t_2.f0 = __pyx_v_xrot2;
  __pyx_t_2.f1 = __pyx_v_yrot2;
  __pyx_r = __pyx_t_2;
  goto __pyx_L0;
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 169;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_6crmflx_9numerical_rot8ang, (void (*)(void))&__pyx_f_6crmflx_9numerical_y_interpolate, (void (*)(void))&__pyx_f_6crmflx_9numerical_compute_rng, (void (*)(void)) NULL};
...
namespace {
  ...
  #endif
  {
      ...
      "numerical",
      __pyx_k_Numerical_operations_shared_by, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "numerical" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_numerical", 0);
  ...
  if (__pyx_module_is_main_crmflx__numerical) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "crmflx.numerical")) {
      if (unlikely((PyDict_SetItemString(modules, "crmflx.numerical", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init crmflx.numerical", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init crmflx.numerical");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{18},{8},{10},{8},{12},{12},{10},{8},{202}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (164 bytes) */
const char* const cstring = "BZh91AY&SY\321\247\362s\000\000\026[\200@\000@d\000@\200\000\277\257\376` \000\222\r&\211\265=\001\250\320\0001L\202\232z\232`\215\351F]\305\210Y\261\250\006\206D\234=\t<8}e\262i\377\0338\351\344\205\277o\317N'\277\330\214\252H\024\201\034\266Z\311\207\302\004 \222lN\344\201\355%f\317\006>\276C\333\315\\\263\300 4rA!\023\014\235\003X=\333\233JPb #7\305I\250w7U\254\371I\220W\345\"\002\311K\362,c\361w$S\205\t\r\032\177'0";
    PyObject *data = __Pyx_DecompressString(cstring, 164, 2);
...
const char* const cstring = "x\332\235\2201\016\3020\014Es\224\216T\342\000l\034\305r\023SE$vHm\211\336\236\244E\2600Tx\371\337\326\373\177\360\325\247\310\004\221A+z\232\320\337\0012\266\275M\226`\211\272c\314\233\226\365\t\036K\354\376a\230\366\373B\032\350\206\226\024@i\321\017\251VZ>\210M\275\0069\274\375p\332\365<\374\326\321\035\343\376\345\277\271*zA\236\335\332^\240T\213$Tr^r1%\250<\277\000j\321ky";
...
const char* const bytes = "?cline_in_traceback__main____module____name____pyx_capi____qualname__setdefault__test____pyx_ctuple_double__and_double (double, double, double, double)\000double (double, double, double, double, double)\000double (double, double, double, double, double, double)\000rot8ang\000y_interpolate\000compute_rng";
    PyObject *data = NULL;
