...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "crmflx.bowshock",
        "sources": [
            "src/crmflx/bowshock.pyx"
        ]
    },
    "module_name": "crmflx.bowshock"
}
END: Cython Metadata */
...
#define __PYX_HAVE__crmflx__bowshock
#define __PYX_HAVE_API__crmflx__bowshock
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
#define __pyx_kp_u_src_crmflx_bowshock_pyx __pyx_string_tab[1]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[2]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[3]
#define __pyx_n_u_bowang __pyx_string_tab[4]
#define __pyx_n_u_bowshk2 __pyx_string_tab[5]
#define __pyx_n_u_bx __pyx_string_tab[6]
#define __pyx_n_u_by __pyx_string_tab[7]
#define __pyx_n_u_bz __pyx_string_tab[8]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[9]
#define __pyx_n_u_crmflx_bowshock __pyx_string_tab[10]
#define __pyx_n_u_dennum __pyx_string_tab[11]
#define __pyx_n_u_func __pyx_string_tab[12]
#define __pyx_n_u_hefrac __pyx_string_tab[13]
...
static CYTHON_INLINE double __pyx_f_6crmflx_8bowshock_fast_func(double __pyx_v_bx, double __pyx_v_by, double __pyx_v_bz, double __pyx_v_alp, double __pyx_v_btot, double __pyx_v_vx, double __pyx_v_va1, double __pyx_v_vs1, double __pyx_v_v01) {
  double __pyx_v_out;
  double __pyx_v_diff;
  double __pyx_v_alfven_sqrd;
  double __pyx_v_sound_sqrd;
  double __pyx_r;
  double __pyx_t_1;
  double __pyx_t_2;
  int __pyx_lineno = 0;
...
*/
  __pyx_v_diff = ((__pyx_v_v01 * __pyx_v_vx) - (__pyx_v_vx * __pyx_v_vx));

  /* "crmflx/bowshock.pyx":39
 *     cdef double out
 *     cdef double diff = v01*vx - vx*vx
 *     cdef double alfven_sqrd = va1*va1             # <<<<<<<<<<<<<<
 *     cdef double sound_sqrd = vs1*vs1
 * 
*/
  __pyx_v_alfven_sqrd = (__pyx_v_va1 * __pyx_v_va1);

  /* "crmflx/bowshock.pyx":40
 *     cdef double diff = v01*vx - vx*vx
 *     cdef double alfven_sqrd = va1*va1
 *     cdef double sound_sqrd = vs1*vs1             # <<<<<<<<<<<<<<
 * 
 *     out = (
*/
  __pyx_v_sound_sqrd = (__pyx_v_vs1 * __pyx_v_vs1);

  /* "crmflx/bowshock.pyx":48
...
*/
  __pyx_t_1 = (((4.0 * __pyx_v_alfven_sqrd) * __pyx_v_sound_sqrd) * pow((((__pyx_v_vx * __pyx_v_bx) + ((__pyx_v_by * sin(__pyx_v_alp)) * sqrt(__pyx_v_diff))) + ((__pyx_v_bz * cos(__pyx_v_alp)) * sqrt(__pyx_v_diff))), 2.0));

  /* "crmflx/bowshock.pyx":53
 ...
 *     )
*/
  __pyx_t_2 = (((__pyx_v_btot * __pyx_v_btot) * __pyx_v_v01) * __pyx_v_vx);
  if (unlikely(__pyx_t_2 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 53, __pyx_L1_error)
  }

  /* "crmflx/bowshock.pyx":45
 ...
 *             - 4.0 * alfven_sqrd * sound_sqrd
*/
  __pyx_v_out = (((__pyx_v_alfven_sqrd + __pyx_v_sound_sqrd) - ((2.0 * __pyx_v_v01) * __pyx_v_vx)) + sqrt((pow((__pyx_v_alfven_sqrd + __pyx_v_sound_sqrd), 2.0) - (__pyx_t_1 / __pyx_t_2))));

  /* "crmflx/bowshock.pyx":57
 *     )
 * 
 *     return out             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("crmflx.bowshock.fast_func", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}

/* "crmflx/bowshock.pyx":59
 *     return out
 * 
 * cdef double fast(             # <<<<<<<<<<<<<<
 *     double bx,
...
static double __pyx_f_6crmflx_8bowshock_fast(double __pyx_v_bx, double __pyx_v_by, double __pyx_v_bz, double __pyx_v_va, double __pyx_v_vs, double __pyx_v_v0, double __pyx_v_alp) {
  CYTHON_UNUSED double __pyx_v_dpr;
  double __pyx_v_btot;
  double __pyx_v_vx;
  double __pyx_v_va1;
  double __pyx_v_vs1;
  double __pyx_v_v01;
  double __pyx_v_func;
  double __pyx_v_step1;
  double __pyx_v_step2;
  double __pyx_v_step3;
  double __pyx_v_vy;
  double __pyx_v_vz;
  double __pyx_v_vms;
  double __pyx_r;
 ...
 *     cdef double vx   = 1
*/
  __pyx_v_dpr = (6.2832 / 360.0);

  /* "crmflx/bowshock.pyx":77
 *     """
 *     cdef double dpr  = 6.2832/360.0
 *     cdef double btot = sqrt(bx * bx + by * by + bz * bz)             # <<<<<<<<<<<<<<
 *     cdef double vx   = 1
...
*/
  __pyx_v_btot = sqrt((((__pyx_v_bx * __pyx_v_bx) + (__pyx_v_by * __pyx_v_by)) + (__pyx_v_bz * __pyx_v_bz)));

  /* "crmflx/bowshock.pyx":78
 *     cdef double dpr  = 6.2832/360.0
 *     cdef double btot = sqrt(bx * bx + by * by + bz * bz)
 *     cdef double vx   = 1             # <<<<<<<<<<<<<<
 *     cdef double va1  = va / 1.0e5
...
*/
  __pyx_v_va1 = (__pyx_v_va / 1.0e5);

  /* "crmflx/bowshock.pyx":80
 *     cdef double vx   = 1
 *     cdef double va1  = va / 1.0e5
 *     cdef double vs1  = vs / 1.0e5             # <<<<<<<<<<<<<<
 *     cdef double v01  = v0 / 1.0e5
 * 
*/
  __pyx_v_vs1 = (__pyx_v_vs / 1.0e5);

  /* "crmflx/bowshock.pyx":81
 *     cdef double va1  = va / 1.0e5
 *     cdef double vs1  = vs / 1.0e5
 *     cdef double v01  = v0 / 1.0e5             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_v_v01 = (__pyx_v_v0 / 1.0e5);

  /* "crmflx/bowshock.pyx":83
 *     cdef double v01  = v0 / 1.0e5
 * 
 *     cdef double func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast_func(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_alp, __pyx_v_btot, __pyx_v_vx, __pyx_v_va1, __pyx_v_vs1, __pyx_v_v01); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 83, __pyx_L1_error)
  __pyx_v_func = __pyx_t_1;

  /* "crmflx/bowshock.pyx":85
 *     cdef double func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)
 * 
 *     cdef double step1 = 2.0             # <<<<<<<<<<<<<<
 ...
 *             vx += step1
*/
  __pyx_t_2 = (__pyx_v_func > 0.0);
  if (__pyx_t_2) {

    /* "crmflx/bowshock.pyx":90
 * 
 *     if func > 0:
 *         while True:             # <<<<<<<<<<<<<<
 *             vx += step1
 ...
 *             if func <= 0:
*/
      __pyx_v_vx = (__pyx_v_vx + __pyx_v_step1);

      /* "crmflx/bowshock.pyx":92
 *         while True:
 *             vx += step1
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)             # <<<<<<<<<<<<<<
 *             if func <= 0:
 *                 break
*/
      __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast_func(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_alp, __pyx_v_btot, __pyx_v_vx, __pyx_v_va1, __pyx_v_vs1, __pyx_v_v01); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 92, __pyx_L1_error)
      __pyx_v_func = __pyx_t_1;

      /* "crmflx/bowshock.pyx":93
 *             vx += step1
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)
 *             if func <= 0:             # <<<<<<<<<<<<<<
 *                 break
 ...
 *             if func >= 0:
*/
      __pyx_v_vx = (__pyx_v_vx - __pyx_v_step2);

      /* "crmflx/bowshock.pyx":98
 *         while True:
 *             vx -= step2
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)             # <<<<<<<<<<<<<<
 *             if func >= 0:
 *                 break
*/
      __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast_func(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_alp, __pyx_v_btot, __pyx_v_vx, __pyx_v_va1, __pyx_v_vs1, __pyx_v_v01); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 98, __pyx_L1_error)
      __pyx_v_func = __pyx_t_1;

      /* "crmflx/bowshock.pyx":99
 *             vx -= step2
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)
 *             if func >= 0:             # <<<<<<<<<<<<<<
 *                 break
 ...
 *             if func <= 0:
*/
      __pyx_v_vx = (__pyx_v_vx + __pyx_v_step3);

      /* "crmflx/bowshock.pyx":104
 *         while True:
 *             vx += step3
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)             # <<<<<<<<<<<<<<
 *             if func <= 0:
 *                 break
*/
      __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast_func(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_alp, __pyx_v_btot, __pyx_v_vx, __pyx_v_va1, __pyx_v_vs1, __pyx_v_v01); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 104, __pyx_L1_error)
      __pyx_v_func = __pyx_t_1;

      /* "crmflx/bowshock.pyx":105
 *             vx += step3
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)
 *             if func <= 0:             # <<<<<<<<<<<<<<
 *                 break
 ...
 *                 break
*/
      __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast_func(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_alp, __pyx_v_btot, __pyx_v_vx, __pyx_v_va1, __pyx_v_vs1, __pyx_v_v01); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 111, __pyx_L1_error)
      __pyx_v_func = __pyx_t_1;

      /* "crmflx/bowshock.pyx":112
 *             vx += step1
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)
 *             if func >= 0:             # <<<<<<<<<<<<<<
 *                 break
 ...
 *                 break
*/
      __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast_func(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_alp, __pyx_v_btot, __pyx_v_vx, __pyx_v_va1, __pyx_v_vs1, __pyx_v_v01); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 117, __pyx_L1_error)
      __pyx_v_func = __pyx_t_1;

      /* "crmflx/bowshock.pyx":118
 *             vx -= step2
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)
 *             if func <= 0:             # <<<<<<<<<<<<<<
 *                 break
 ...
 *                 break
*/
      __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast_func(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_alp, __pyx_v_btot, __pyx_v_vx, __pyx_v_va1, __pyx_v_vs1, __pyx_v_v01); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 123, __pyx_L1_error)
      __pyx_v_func = __pyx_t_1;

      /* "crmflx/bowshock.pyx":124
 *             vx += step3
 *             func = fast_func(bx, by, bz, alp, btot, vx, va1, vs1, v01)
 *             if func >= 0:             # <<<<<<<<<<<<<<
 *                 break
 ...
 * 
*/
  __pyx_v_vy = (sin(__pyx_v_alp) * sqrt(((__pyx_v_v01 * __pyx_v_vx) - pow(__pyx_v_vx, 2.0))));

  /* "crmflx/bowshock.pyx":128
 * 
 *     cdef double vy = sin(alp) * sqrt(v01 * vx - vx**2)
 *     cdef double vz = cos(alp) * sqrt(v01 * vx - vx**2)             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_v_vz = (cos(__pyx_v_alp) * sqrt(((__pyx_v_v01 * __pyx_v_vx) - pow(__pyx_v_vx, 2.0))));

  /* "crmflx/bowshock.pyx":130
 *     cdef double vz = cos(alp) * sqrt(v01 * vx - vx**2)
 * 
 *     cdef double vms = 1.0e5 * sqrt(vx * vx + vy * vy + vz * vz)             # <<<<<<<<<<<<<<
 * 
 *     return vms
*/
  __pyx_v_vms = (1.0e5 * sqrt((((__pyx_v_vx * __pyx_v_vx) + (__pyx_v_vy * __pyx_v_vy)) + (__pyx_v_vz * __pyx_v_vz))));

  /* "crmflx/bowshock.pyx":132
 *     cdef double vms = 1.0e5 * sqrt(vx * vx + vy * vy + vz * vz)
 * 
 *     return vms             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("crmflx.bowshock.fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static double __pyx_f_6crmflx_8bowshock_bowshk2(double __pyx_v_bx, double __pyx_v_by, double __pyx_v_bz, double __pyx_v_vx, double __pyx_v_vy, double __pyx_v_vz, double __pyx_v_dennum, double __pyx_v_swetemp, double __pyx_v_swptemp, double __pyx_v_hefrac, double __pyx_v_swhtemp, double __pyx_v_xpos, double __pyx_v_bowang, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  double __pyx_v_dpr;
  CYTHON_UNUSED double __pyx_v_rade;
  double __pyx_v_pi;
  ...
  double __pyx_v_xn;
  double __pyx_v_eps;
  double __pyx_v_btotcgs;
  CYTHON_UNUSED double __pyx_v_btot;
  double __pyx_v_vtot;
  double __pyx_v_vtot1;
  double __pyx_v_v_a;
  double __pyx_v_pres1;
  double __pyx_v_c_s;
  CYTHON_UNUSED double __pyx_v_m_a;
  CYTHON_UNUSED double __pyx_v_m_s;
  double __pyx_v_m_f;
  double __pyx_v_xnave;
  double __pyx_v_vave;
  double __pyx_v_fracpres;
  double __pyx_v_xn1;
  double __pyx_v_a;
  double __pyx_v_b;
  double __pyx_v_c;
  double __pyx_v_xtemp;
  double __pyx_v_rho2;
  double __pyx_v_ave_ma;
  double __pyx_v_ave_ms;
  double __pyx_v_vwin_ave;
  double __pyx_v_va_ave;
  double __pyx_v_vs_ave;
  double __pyx_v_vms;
  double __pyx_v_ave_mf;
  double __pyx_v_thet2;
  double __pyx_v_thet1;
  double __pyx_v_bowrad;
  double __pyx_r;
  double __pyx_t_1;
  double __pyx_t_2;
  int __pyx_t_3;
...
*/
  __pyx_v_etemp = (__pyx_v_swetemp / 11600.);

  /* "crmflx/bowshock.pyx":176
 * #
 *     cdef double etemp  = swetemp / 11600.
 *     cdef double ptemp  = swptemp / 11600.             # <<<<<<<<<<<<<<
 *     cdef double hetemp = swhtemp / 11600.
 *     cdef double dpr    = 6.2832  / 360.0
*/
  __pyx_v_ptemp = (__pyx_v_swptemp / 11600.);

  /* "crmflx/bowshock.pyx":177
 *     cdef double etemp  = swetemp / 11600.
 *     cdef double ptemp  = swptemp / 11600.
 *     cdef double hetemp = swhtemp / 11600.             # <<<<<<<<<<<<<<
 *     cdef double dpr    = 6.2832  / 360.0
...
*/
  __pyx_v_hetemp = (__pyx_v_swhtemp / 11600.);

  /* "crmflx/bowshock.pyx":178
 *     cdef double ptemp  = swptemp / 11600.
 *     cdef double hetemp = swhtemp / 11600.
 *     cdef double dpr    = 6.2832  / 360.0             # <<<<<<<<<<<<<<
 *     cdef double rade   = 6378.0
...
*/
  __pyx_v_gamma = (5.0 / 3.0);

  /* "crmflx/bowshock.pyx":190
...
*/
  __pyx_v_xl = 22.073117134;

  /* "crmflx/bowshock.pyx":191
 * #
 *     cdef double xl = 22.073117134
 *     cdef double x0 =  3.493725046             # <<<<<<<<<<<<<<
 *     cdef double xn = 14.422071657
 * #
*/
  __pyx_v_x0 = 3.493725046;

  /* "crmflx/bowshock.pyx":192
 *     cdef double xl = 22.073117134
 *     cdef double x0 =  3.493725046
 *     cdef double xn = 14.422071657             # <<<<<<<<<<<<<<
 * #
...
*/
  __pyx_v_xn = 14.422071657;

  /* "crmflx/bowshock.pyx":197
...
*/
  __pyx_v_btotcgs = (sqrt((((__pyx_v_bx * __pyx_v_bx) + (__pyx_v_by * __pyx_v_by)) + (__pyx_v_bz * __pyx_v_bz))) * 1.e-5);

  /* "crmflx/bowshock.pyx":205
 * #
 *     cdef double btotcgs = sqrt(bx * bx + by * by + bz * bz) * 1.e-5    #--- btot in cgs units
 *     cdef double btot    = btotcgs * 1.e+5                                   #--- btot in mks units             # <<<<<<<<<<<<<<
 *     cdef double vtot    = sqrt(vx * vx + vy * vy + vz * vz) * 1.e+5    #--- vtot in cm/sec
...
*/
  __pyx_v_btot = (__pyx_v_btotcgs * 1.e+5);

  /* "crmflx/bowshock.pyx":206
 *     cdef double btotcgs = sqrt(bx * bx + by * by + bz * bz) * 1.e-5    #--- btot in cgs units
 *     cdef double btot    = btotcgs * 1.e+5                                   #--- btot in mks units
 *     cdef double vtot    = sqrt(vx * vx + vy * vy + vz * vz) * 1.e+5    #--- vtot in cm/sec             # <<<<<<<<<<<<<<
 *     cdef double vtot1   = sqrt(vx * vx + vy * vy + vz * vz)            #--- vtot in km/sec
 * #
*/
  __pyx_v_vtot = (sqrt((((__pyx_v_vx * __pyx_v_vx) + (__pyx_v_vy * __pyx_v_vy)) + (__pyx_v_vz * __pyx_v_vz))) * 1.e+5);

  /* "crmflx/bowshock.pyx":207
 *     cdef double btot    = btotcgs * 1.e+5                                   #--- btot in mks units
 *     cdef double vtot    = sqrt(vx * vx + vy * vy + vz * vz) * 1.e+5    #--- vtot in cm/sec
 *     cdef double vtot1   = sqrt(vx * vx + vy * vy + vz * vz)            #--- vtot in km/sec             # <<<<<<<<<<<<<<
 * #
...
*/
  __pyx_v_vtot1 = sqrt((((__pyx_v_vx * __pyx_v_vx) + (__pyx_v_vy * __pyx_v_vy)) + (__pyx_v_vz * __pyx_v_vz)));

  /* "crmflx/bowshock.pyx":212
...
*/
  __pyx_t_1 = sqrt(((((4.0 * __pyx_v_pi) * __pyx_v_dennum) * 1.67e-24) * (1.0 + (__pyx_v_hefrac * 4.0))));
  if (unlikely(__pyx_t_1 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 212, __pyx_L1_error)
  }
  __pyx_v_v_a = (__pyx_v_btotcgs / __pyx_t_1);

  /* "crmflx/bowshock.pyx":213
 * #
 *     cdef double v_a   = btotcgs / sqrt(4.0 * pi * dennum * 1.67e-24 * (1.0 + hefrac * 4.0))
 *     cdef double pres1 = dennum * ((1.0 + hefrac * 2.0) * etemp + (1 + hefrac * hetemp) * ptemp) * 1.602e-12             # <<<<<<<<<<<<<<
 *     cdef double c_s   = sqrt(2.0 * pres1 / (dennum * 1.67e-24 * (1.0 + hefrac * 4.0)))
 * #
*/
  __pyx_v_pres1 = ((__pyx_v_dennum * (((1.0 + (__pyx_v_hefrac * 2.0)) * __pyx_v_etemp) + ((1.0 + (__pyx_v_hefrac * __pyx_v_hetemp)) * __pyx_v_ptemp))) * 1.602e-12);

  /* "crmflx/bowshock.pyx":214
 *     cdef double v_a   = btotcgs / sqrt(4.0 * pi * dennum * 1.67e-24 * (1.0 + hefrac * 4.0))
 *     cdef double pres1 = dennum * ((1.0 + hefrac * 2.0) * etemp + (1 + hefrac * hetemp) * ptemp) * 1.602e-12
 *     cdef double c_s   = sqrt(2.0 * pres1 / (dennum * 1.67e-24 * (1.0 + hefrac * 4.0)))             # <<<<<<<<<<<<<<
 * #
...
*/
  __pyx_t_1 = (2.0 * __pyx_v_pres1);
  __pyx_t_2 = ((__pyx_v_dennum * 1.67e-24) * (1.0 + (__pyx_v_hefrac * 4.0)));
  if (unlikely(__pyx_t_2 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 214, __pyx_L1_error)
  }
  __pyx_v_c_s = sqrt((__pyx_t_1 / __pyx_t_2));

  /* "crmflx/bowshock.pyx":220
...
*/
  if (unlikely(__pyx_v_v_a == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 220, __pyx_L1_error)
  }
  __pyx_v_m_a = (__pyx_v_vtot / __pyx_v_v_a);

  /* "crmflx/bowshock.pyx":221
 * #
 *     cdef double m_a = vtot / v_a
 *     cdef double m_s = vtot / c_s             # <<<<<<<<<<<<<<
 *     cdef double m_f = vtot / sqrt(v_a * v_a + c_s * c_s)
 * #
*/
  if (unlikely(__pyx_v_c_s == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 221, __pyx_L1_error)
  }
  __pyx_v_m_s = (__pyx_v_vtot / __pyx_v_c_s);

  /* "crmflx/bowshock.pyx":222
 *     cdef double m_a = vtot / v_a
 *     cdef double m_s = vtot / c_s
 *     cdef double m_f = vtot / sqrt(v_a * v_a + c_s * c_s)             # <<<<<<<<<<<<<<
 * #
...
*/
  __pyx_t_2 = sqrt(((__pyx_v_v_a * __pyx_v_v_a) + (__pyx_v_c_s * __pyx_v_c_s)));
  if (unlikely(__pyx_t_2 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 222, __pyx_L1_error)
  }
  __pyx_v_m_f = (__pyx_v_vtot / __pyx_t_2);

  /* "crmflx/bowshock.pyx":229
 ...
 *     xn1 = xn * fracpres
*/
  __pyx_t_2 = ((__pyx_v_xnave * __pyx_v_vave) * __pyx_v_vave);
  __pyx_t_1 = ((__pyx_v_dennum * __pyx_v_vtot1) * __pyx_v_vtot1);
  if (unlikely(__pyx_t_1 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 236, __pyx_L1_error)
  }
  __pyx_v_fracpres = pow((__pyx_t_2 / __pyx_t_1), (1.0 / 6.0));

  /* "crmflx/bowshock.pyx":238
 *     cdef double fracpres = ((xnave * vave * vave) / (dennum * vtot1 * vtot1))**(1.0/6.0)
 * 
 *     xn1 = xn * fracpres             # <<<<<<<<<<<<<<
 *     x0  = x0 * fracpres
 *     xl  = xl * fracpres
*/
  __pyx_v_xn1 = (__pyx_v_xn * __pyx_v_fracpres);

  /* "crmflx/bowshock.pyx":239
 * 
 *     xn1 = xn * fracpres
 *     x0  = x0 * fracpres             # <<<<<<<<<<<<<<
 *     xl  = xl * fracpres
 * #
*/
  __pyx_v_x0 = (__pyx_v_x0 * __pyx_v_fracpres);

  /* "crmflx/bowshock.pyx":240
 *     xn1 = xn * fracpres
 *     x0  = x0 * fracpres
 *     xl  = xl * fracpres             # <<<<<<<<<<<<<<
 * #
...
*/
  __pyx_v_xl = (__pyx_v_xl * __pyx_v_fracpres);

  /* "crmflx/bowshock.pyx":244
 * #--- calculate yet again the parameters for the updated model
 * #
...
*/
  __pyx_v_a = ((__pyx_v_eps * __pyx_v_eps) - 1.0);

  /* "crmflx/bowshock.pyx":245
 * #
 *     cdef double a = eps * eps -1
 *     cdef double b = 2.0 * eps * xl + 2.0 *( eps * eps -1) * x0             # <<<<<<<<<<<<<<
 *     cdef double c = xl * xl + 2.0 * eps * xl * x0 + (eps * eps -1) * x0 * x0
 * #
*/
  __pyx_v_b = (((2.0 * __pyx_v_eps) * __pyx_v_xl) + ((2.0 * ((__pyx_v_eps * __pyx_v_eps) - 1.0)) * __pyx_v_x0));

  /* "crmflx/bowshock.pyx":246
 *     cdef double a = eps * eps -1
 *     cdef double b = 2.0 * eps * xl + 2.0 *( eps * eps -1) * x0
 *     cdef double c = xl * xl + 2.0 * eps * xl * x0 + (eps * eps -1) * x0 * x0             # <<<<<<<<<<<<<<
 * #
...
*/
  __pyx_v_c = (((__pyx_v_xl * __pyx_v_xl) + (((2.0 * __pyx_v_eps) * __pyx_v_xl) * __pyx_v_x0)) + ((((__pyx_v_eps * __pyx_v_eps) - 1.0) * __pyx_v_x0) * __pyx_v_x0));

  /* "crmflx/bowshock.pyx":250
 * #--- calculate shock with correct pressure
 * #
 ...
 *     if xtemp < 0:
*/
  __pyx_v_xtemp = (((__pyx_v_a * pow(__pyx_v_xpos, 2.0)) - (__pyx_v_b * __pyx_v_xpos)) + __pyx_v_c);

  /* "crmflx/bowshock.pyx":252
 *     cdef double xtemp = a * xpos**2 - b * xpos + c
 *     cdef double rho2
 *     if xtemp < 0:             # <<<<<<<<<<<<<<
 *         rho2 = 0
 *     else:
*/
  __pyx_t_3 = (__pyx_v_xtemp < 0.0);
  if (__pyx_t_3) {

    /* "crmflx/bowshock.pyx":253
 *     cdef double rho2
 *     if xtemp < 0:
 *         rho2 = 0             # <<<<<<<<<<<<<<
 *     else:
...
*/
  /*else*/ {
    __pyx_v_rho2 = sqrt(__pyx_v_xtemp);
  }
  __pyx_L3:;

  /* "crmflx/bowshock.pyx":262
...
*/
  __pyx_v_vwin_ave = (430.0 * 1.e+5);

  /* "crmflx/bowshock.pyx":265
 *     cdef double ave_ms   = 7.2
 *     cdef double vwin_ave = 430.0*1.e+5
 *     cdef double va_ave   = vwin_ave / ave_ma             # <<<<<<<<<<<<<<
 *     cdef double vs_ave   = vwin_ave / ave_ms
 * 
*/
  if (unlikely(__pyx_v_ave_ma == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 265, __pyx_L1_error)
  }
  __pyx_v_va_ave = (__pyx_v_vwin_ave / __pyx_v_ave_ma);

  /* "crmflx/bowshock.pyx":266
 *     cdef double vwin_ave = 430.0*1.e+5
 *     cdef double va_ave   = vwin_ave / ave_ma
 *     cdef double vs_ave   = vwin_ave / ave_ms             # <<<<<<<<<<<<<<
 * 
...
*/
  if (unlikely(__pyx_v_ave_ms == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 266, __pyx_L1_error)
  }
  __pyx_v_vs_ave = (__pyx_v_vwin_ave / __pyx_v_ave_ms);

  /* "crmflx/bowshock.pyx":268
 *     cdef double vs_ave   = vwin_ave / ave_ms
 * 
 *     cdef double vms      = sqrt(0.5 * ((va_ave**2 + vs_ave**2) \             # <<<<<<<<<<<<<<
...
*/
  __pyx_v_vms = sqrt((0.5 * ((pow(__pyx_v_va_ave, 2.0) + pow(__pyx_v_vs_ave, 2.0)) + sqrt((pow((pow(__pyx_v_va_ave, 2.0) + pow(__pyx_v_vs_ave, 2.0)), 2.0) - (((4.0 * pow(__pyx_v_va_ave, 2.0)) * pow(__pyx_v_vs_ave, 2.0)) * pow(cos((45.0 * __pyx_v_dpr)), 2.0)))))));

  /* "crmflx/bowshock.pyx":272
 *                 - 4.0 * va_ave**2 * vs_ave**2 *(cos(45 * dpr)**2))))
 * 
 *     ave_mf   = vwin_ave / vms             # <<<<<<<<<<<<<<
 ...
 * #
*/
  if (unlikely(__pyx_v_vms == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 272, __pyx_L1_error)
  }
  __pyx_v_ave_mf = (__pyx_v_vwin_ave / __pyx_v_vms);

  /* "crmflx/bowshock.pyx":273
 * 
 *     ave_mf   = vwin_ave / vms
 *     cdef double thet2    = asin(1.0 / ave_mf)             # <<<<<<<<<<<<<<
 * #
...
*/
  if (unlikely(__pyx_v_ave_mf == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 273, __pyx_L1_error)
  }
  __pyx_v_thet2 = asin((1.0 / __pyx_v_ave_mf));

  /* "crmflx/bowshock.pyx":282
 ...
 *     m_f = vtot / vms
*/
  __pyx_t_1 = __pyx_f_6crmflx_8bowshock_fast(__pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_v_a, __pyx_v_c_s, __pyx_v_vtot, __pyx_v_bowang); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 282, __pyx_L1_error)
  __pyx_v_vms = __pyx_t_1;

  /* "crmflx/bowshock.pyx":284
 *     vms = fast(bx,by,bz,v_a,c_s,vtot,bowang)
 * 
 *     m_f = vtot / vms             # <<<<<<<<<<<<<<
...
*/
  ...
  __pyx_v_m_f = (__pyx_v_vtot / __pyx_v_vms);

  /* "crmflx/bowshock.pyx":285
 * 
 *     m_f = vtot / vms
 *     cdef double thet1 = asin(1.0 / m_f)             # <<<<<<<<<<<<<<
 *     cdef double bowrad = rho2 + (xn1 - xpos) * (tan(thet1) - tan(thet2)) #: rhox
 *     return bowrad
*/
  if (unlikely(__pyx_v_m_f == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 285, __pyx_L1_error)
  }
  __pyx_v_thet1 = asin((1.0 / __pyx_v_m_f));

  /* "crmflx/bowshock.pyx":286
 *     m_f = vtot / vms
 *     cdef double thet1 = asin(1.0 / m_f)
 *     cdef double bowrad = rho2 + (xn1 - xpos) * (tan(thet1) - tan(thet2)) #: rhox             # <<<<<<<<<<<<<<
 *     return bowrad
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("crmflx.bowshock.bowshk2", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("bowshk2 (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_r = __pyx_pf_6crmflx_8bowshock_bowshk2(__pyx_self, __pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_vx, __pyx_v_vy, __pyx_v_vz, __pyx_v_dennum, __pyx_v_swetemp, __pyx_v_swptemp, __pyx_v_hefrac, __pyx_v_swhtemp, __pyx_v_xpos, __pyx_v_bowang);
...
static int __pyx_pymod_exec_bowshock(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_bowshock},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "bowshock",
      __pyx_k_this_module_is_designed_to_give, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_bowshock(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_bowshock(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_bowshock(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'bowshock' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "bowshock" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_bowshock", 0);
  ...
  if (__pyx_module_is_main_crmflx__bowshock) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "crmflx.bowshock")) {
      if (unlikely((PyDict_SetItemString(modules, "crmflx.bowshock", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init crmflx.bowshock", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init crmflx.bowshock");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
