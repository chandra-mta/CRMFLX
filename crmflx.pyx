...
def scalkp2(xkp,ispeci):
	...
	"""
	#sector limits and proton flux scaling parameters
	#------------------------------------------------------------------------------------
	#-- create a dictionary to hold the different sectors instead of calling functions --
	#------------------------------------------------------------------------------------
	...
	sectors = {
	1: {'xpar' : [-20.0,   0.0], 'ypar' : [ 15.0,  30.0], 'fmnp' : [1.006261,    0.2358533], 'f95p' : [1.242684,    0.167599],
	'f50p' : [3.595895e-1, 1.485105], 'fsgp' : [1.154729,    0.1813815], 'favp' : [1.006261,    0.2358533], 'mtd' : 4},
	2: {'xpar' : [ -5.0,  15.0], 'ypar' : [ 10.0,  23.0], 'fmnp' : [1.075755,    0.228047], 'f95p' : [1.28287,     0.1789508],
	'f50p' : [4.152996e-1, 1.144803], 'fsgp' : [1.231504,    0.1678395], 'favp' : [1.075755,    0.228047], 'mtd' : 4},
	3: {'xpar' : [ -5.0,  15.0], 'ypar' : [-10.0,  10.0], 'fmnp' : [1.059922,    0.2450142], 'f95p' : [1.262771,    0.2122456],
	'f50p' : [2.699979e-1, 1.92621], 'fsgp' : [1.170143    ,0.2329764], 'favp' : [1.059922,    0.2450142], 'mtd' : 4},
	4: {'xpar' : [-25.0,   5.0], 'ypar' : [-30.0, -12.0], 'fmnp' : [0.8034997, 0.2943536], 'f95p' : [1.029681,  0.2502851],
	'f50p' : [0.6214508, 0.2912395], 'fsgp' : [0.890587,  0.2943353], 'favp' : [0.8034997, 0.2943536], 'mtd' : 2}
	}
	#f_list = [sectr21, sectr22, sectr23, sectr24]

	return get_scalkp(sectors, xkp, ispeci)
...
def scalkp3(xkp,ispeci):
	...
	#    sector   3:  (-18<x<-12; -18<y<-11; all z)
	#    sector   4:  (-28<x<-21; -18<y<-10; all z)
	#    sector   5:  (-29<x<-25; -10<y<-3; all z)
	#    sector   6:  (-20<x<-15; +1<y<+10; all z)
	#    sector   7:  (-19<x<-14; +10<y<+19; all z)
	#    sector   8:  (-30<x<-24; +10<y<+17; all z)
	#    sector   9:  (0<x<+8; +8<y<+13; all z)
	#    sector  10:  (0<x<+8; -11<y<-6; all z)
	sectors = {
	1: {'xpar': [-10.0, -6.0], 'ypar' : [ -6.0,  4.0], 'fmnp' : [2.443395e-1, 3.845401], 'f95p' : [4.539177,    3.807753e-2],
	'f50p' : [3.058675e-1, 3.264229], 'fsgp' : [2.038728e-1, 4.088105], 'favp' : [2.443395e-1, 3.845401], 'mtd' : 3},
	2: {'xpar': [-7.0,  0.0], 'ypar' : [ 8.0, 13.0], 'fmnp' : [1.430943, 1.431528e-1], 'f95p' : [1.510317, 1.432958e-1], 
	'f50p' : [1.285142, 1.935917e-1], 'fsgp' : [1.544309, 8.922371e-2], 'favp' : [1.430943, 1.431528e-1], 'mtd' : 2},
	3: {'xpar' : [-18.0, -12.0], 'ypar' : [-18.0, -11.0], 'fmnp' : [4.0986685e-1, 2.083598], 'f95p' : [3.677568e-1,  2.792231],
	'f50p' : [4.706894e-1,  1.382612], 'fsgp' : [3.606812e-1,  2.440727], 'favp' : [4.0986685e-1, 2.083598], 'mtd' : 1},
	4: {'xpar' : [-28.0, -21.0], 'ypar' : [-18.0, -10.0], 'fmnp' : [3.249438e-1, 2.425203], 'f95p' : [2.860754e-1, 3.135966],
	'f50p' : [3.848902e-1, 1.684094], 'fsgp' : [2.574007e-1, 2.909206], 'favp' : [3.249438e-1, 2.425203], 'mtd' : 1},
	5: {'xpar' : [-29.0, -25.0], 'ypar' : [-10.0,  -3.0], 'fmnp' : [4.343142e-1, 2.180041], 'f95p' : [4.123490e-1, 2.759741], 
	'f50p' : [4.826937e-1, 1.563440], 'fsgp' : [3.533449e-1, 2.641683], 'favp' : [4.343142e-1, 2.180041], 'mtd' : 1},
	6: {'xpar' : [-20.0, -15.0], 'ypar' : [  1.0,  10.0], 'fmnp' : [1.270656, 2.230935e-1], 'f95p' : [1.436059, 1.577674e-1],
	'f50p' : [1.051924, 3.327092e-1], 'fsgp' : [1.332255, 1.706059e-1], 'favp' : [1.270656, 2.230935e-1], 'mtd' : 2},
	7: {'xpar' : [-19.0, -14.0], 'ypar' : [ 10.0,  19.0], 'fmnp' : [3.213946e-1, 2.964045], 'f95p' : [2.901571e-1, 3.628429],
	'f50p' : [3.349902e-1, 2.415445], 'fsgp' : [2.934793e-1, 3.251733], 'favp' : [3.213946e-1, 2.964045], 'mtd' : 1},
	8: {'xpar' : [-30.0, -24.0], 'ypar' : [ 10.0,  17.0], 'fmnp' : [1.114799,    2.013791e-1], 'f95p' : [1.283152,    1.715240e-1],
	'f50p' : [8.948732e-1, 2.100576e-1], 'fsgp' : [1.232212,    1.728799e-1], 'favp' : [1.114799,    2.013791e-1], 'mtd' : 2},
	9: {'xpar' : [0.0,  8.0], 'ypar' : [8.0, 13.0], 'fmnp' : [2.373299e-1, 3.988981], 'f95p' : [1.769049e-1, 4.660334], 
	'f50p' : [2.427994e-1, 3.717080], 'fsgp' : [2.079478e-1, 4.169556], 'favp' : [2.373299e-1, 3.988981], 'mtd' : 1},
	10: {'xpar' : [-8.0,   -6.0], 'ypar' : [-16.0, -14.0], 'fmnp' : [2.373299e-1, 3.988981], 'f95p' : [1.769049e-1, 4.660334], 
	'f50p' : [2.427994e-1, 3.717080], 'fsgp' : [2.079478e-1, 4.169556], 'favp' : [2.373299e-1, 3.988981], 'mtd' : 1}
	}
...
def get_scalkp(sectors, xkp,ispeci):
	"""
...
#
		sctr = sectors[key]
		xpar, ypar = sctr['xpar'], sctr['ypar']
		fmnp, f95p, f50p, fsgp, favp, mtd =  sctr['fmnp'], sctr['f95p'], sctr['f50p'], sctr['fsgp'], sctr['favp'], sctr['mtd']
		for m in range(1, 10):
			m1= m  -1
			xkpsc = m - 0.5
		 
			out = sect_comp(ispeci, xkp, xkpsc, xpar, ypar, fmnp, f95p, f50p, fsgp, favp, mtd)
			scmean[k,m1] = out[0]
			sc95[k,m1]   = out[1]
			sc50[k,m1]   = out[2]
			scsig[k,m1]  = out[3]
