...
if USE_CYTHON and Path("src/crmflx/locate_region.pyx").exists():
    ext = ".pyx"
else:
    ext = ".c"

extensions = [
    Extension("crmflx.bowshock", ["src/crmflx/bowshock.pyx"], libraries=["m"]),
    Extension("crmflx.numerical", ["src/crmflx/numerical.pyx"], libraries=["m"]),
    Extension("crmflx.locate_region", ["src/crmflx/locate_region.pyx"], libraries=["m"]),
]
